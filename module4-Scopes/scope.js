...
function check() {
    ...
    try {
        console.log("Accessing block scope variable(declared with const) outside block: " + const_b);
    }
    catch (error) {
        console.log("Accessing block scope(with const) variable outside block: " + error.message);
    }
}
check();
try {
